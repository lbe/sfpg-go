...
The version in version.go is incremented based upon activity in this repo. Always include the current version.go in your commits. Include the version in the commit message.
